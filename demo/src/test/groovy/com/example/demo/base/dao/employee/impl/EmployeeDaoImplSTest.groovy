...
class EmployeeDaoImplSTest {
    ...
    static class TestSelect extends Specification {
        ...
        def setup() {
            ...
            databaseTester.dataSet = loader.loadDataSet(ResourceUtils.getURL("src/test/groovy/com/example/demo/base/dao/employee/impl/"))
        ...
        def "selectOne動作確認: 取得データ有"() {
            ...
            when:
            def dto = employeeDao.selectOne(employeeId)
    ...
    static class TestDeleteOne extends Specification {
        ...
        def execute() {
            employeeDao.deleteOne(employeeId)
        }
